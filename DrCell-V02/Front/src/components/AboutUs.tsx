      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-24">
          <div className="text-left">
            ...
            <h1 className="text-5xl font-bold text-[#217AB6] mb-4">
              Somos DRCELL, Reparacion De Equipos
            </h1>
            <p className="text-gray-700 mb-6 leading-relaxed">
              Desde 2006 en{" "}
              <strong className="font-semibold text-gray-800">
                Libertador 326, Moreno
              </strong>
              , nos dedicamos a devolverle la vida a tus dispositivos con
              honestidad y expertise. Somos una tienda familiar atendida por su
              dueño, donde cada reparación lleva nuestro sello de calidad y{" "}
              <strong className="font-semibold text-gray-800">
                garantía escrita
              </strong>
              .
            ...
            <button
              className="bg-[#17436b] text-white font-bold py-3 px-6 rounded-full hover:bg-[#17436b] transition duration-300 transform hover:scale-105"
              onClick={() =>
                window.open(
                  "https://www.google.com/maps/place/Dr.+Cell/@-34.6456948,-58.7926662,17z/data=!3m1!4b1!4m6!3m5!1s0x95bc9451ecf381a7:0x3b2ca7b87e0d586c!8m2!3d-34.6456992!4d-58.7900859!16s%2Fg%2F11j8zg3616?entry=ttu&g_ep=EgoyMDI1MDYyMi4wIKXMDSoASAFQAw%3D%3D",
                  "_blank"
                )
              }
            >
          ...
          <div className="relative w-full flex items-center justify-center my-4">
            ...
            <img
              ...
              className="rounded-2xl shadow-lg max-w-full max-h-[450px] object-contain mx-auto transition-opacity duration-700"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-24">
          ...
          <div className="text-left">
            <h2 className="text-5xl font-bold text-[#17436b] mb-6">
              Nuestros pilares
            </h2>
            <ul className="space-y-4 text-gray-700 leading-relaxed">
              <li>
                <strong className="font-semibold text-[#217AB6]">
                  18 años de experiencia:
                </strong>{" "}
                Más de 15,000 reparaciones exitosas.
              </li>
              <li>
                <strong className="font-semibold text-[#217AB6]">
                  Diagnóstico claro:
                </strong>{" "}
                Te explicamos el problema sin tecnicismos innecesarios.
              </li>
              <li>
                <strong className="font-semibold text-[#217AB6]">
                  Garantía real:
                </strong>{" "}
                15 días en todas las reparaciones.
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-[#17436b] mt-2 mb-4">
        ...
        <div className="text-center mb-12">
          <h3 className="text-[#217AB6] font-semibold uppercase tracking-wider">
            Por qué elegirnos
          </h3>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-100 p-8 rounded-lg shadow-md text-left transition-transform transform hover:scale-105 hover:shadow-xl">
            ...
            <p className="text-gray-600 leading-relaxed">
              Tu dispositivo es revisado por expertos con décadas de
              experiencia.
            </p>
          </div>
          {/* Item 2 */}
          <div className="bg-gray-100 p-8 rounded-lg shadow-md text-left transition-transform transform hover:scale-105 hover:shadow-xl">
            ...
            <p className="text-gray-600 leading-relaxed">
              Sin costos ocultos; presupuesto previo con tu aprobación.
            </p>
          </div>
          {/* Item 3 */}
          <div className="bg-gray-100 p-8 rounded-lg shadow-md text-left transition-transform transform hover:scale-105 hover:shadow-xl">
            ...
            <p className="text-gray-600 leading-relaxed">
              Usamos componentes originales o equivalentes certificados. No
              trabajamos con repuestos genéricos o usados.
            </p>
          </div>
          {/* Item 4 */}
          <div className="bg-gray-100 p-8 rounded-lg shadow-md text-left transition-transform transform hover:scale-105 hover:shadow-xl">
            ...
            <p className="text-gray-600 leading-relaxed">
              98% de las reparaciones se completan en menos de 3 horas.
            </p>
          </div>
          {/* Item 5 */}
          <div className="bg-gray-100 p-8 rounded-lg shadow-md text-left transition-transform transform hover:scale-105 hover:shadow-xl">
            ...
            <p className="text-gray-600 leading-relaxed">
              Ofrecemos garantía en los repuestos de 15 días. Siempre con su
              voleta en mano.
            </p>
          </div>
          {/* Item 6 */}
          <div className="bg-gray-100 p-8 rounded-lg shadow-md text-left transition-transform transform hover:scale-105 hover:shadow-xl">
            ...
            <p className="text-gray-600 leading-relaxed">
              Dedicamos nuestros tiempo a la venta de equipos nuevos o usados.
              Nos ajustamos al presupuesto del cliente.
            </p>
          </div>
        </div>
      </div>
