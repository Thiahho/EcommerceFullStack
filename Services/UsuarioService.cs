...
namespace EcommerceFS.Services
{
    public class UsuarioService : IUsuarioService
    {
        ...
        public async Task<Usuarios?> ValidarCredencialesAsync(string email, string password)
        {
            try
            {
                ...
                try
                {
                    bool claveOk = BCrypt.Net.BCrypt.Verify(password, usuario.Password);
        ...
        public async Task<Usuarios?> ObtenerUsuarioPorEmailAsync(string email)
        {
            try
            {
